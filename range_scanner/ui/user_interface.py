...
class ScannerProperties(PropertyGroup):
    ...
    joinMeshes: BoolProperty(
        name="Join static meshes", description="Join all static meshes in the scene", default=False
    )
    ...
    distanceLower: FloatProperty(
        name="Lower distance", description="minimum angle (degree)", default=50.0, min=0, max=99999
    )
    ...
    distanceUpper: FloatProperty(
        name="Upper distance", description="minimum angle (degree)", default=120, min=0, max=999999
    )
    ...
    addConstantNoise: BoolProperty(
        name="Add constant offset", description="Enable or disable constant offset", default=True
    )
    ...
    resolutionX: IntProperty(
        name="Width", description="Number of pixels in x direction", default=320, min=1, max=1000000
    )
    ...
    noiseLevel: FloatProperty(
        name="Noise level", description="The noise level in dB", default=50.0, min=0.01, max=10000.0
    )
    ...
    if properties.joinMeshes:
        ...
        targets = list(
            filter(
                ...
                and "partID" not in x,  # exclude objects with semantic mappings
