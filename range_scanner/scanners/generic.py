...
def getTargetIndices(targets, debugOutput):
    ...
    for material in bpy.data.materials:
        ...
        if materialName not in partIDs:
...
def startScan(context, dependencies_installed, properties, objectName):
    ...
    if properties.scannerType == ScannerType.sideScan.name:
        ...
        sonar.performScan(
            ...
            properties.addMesh,
            properties.exportLAS and dependencies_installed,
            properties.exportHDF and dependencies_installed,
            properties.exportCSV,
            properties.exportPLY and dependencies_installed,
        ...
        for frameNumber in frameRange:
            ...
            numberOfHits = lidar.performScan(
                ...
                properties.exportLAS and dependencies_installed and properties.exportSingleFrames,
                properties.exportHDF and dependencies_installed and properties.exportSingleFrames,
                properties.exportCSV and properties.exportSingleFrames,
                properties.exportPLY and dependencies_installed and properties.exportSingleFrames,
                properties.exportRenderedImage,
                properties.exportSegmentedImage,
                properties.exportPascalVoc and dependencies_installed,
        ...
        if not properties.exportSingleFrames:
            ...
            if len(slicedScannedValues) > 0:
                ...
                if (
                    (properties.exportLAS and dependencies_installed)
                    or (properties.exportHDF and dependencies_installed)
                    or (properties.exportCSV and dependencies_installed)
                    or (properties.exportPLY and dependencies_installed)
                ):
